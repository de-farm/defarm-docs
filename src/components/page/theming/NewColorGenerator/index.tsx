    ...
    <div className={styles.newColorGenerator}>
      ...
      <pre className={styles.codePre}>
        <code>
          ...
          {"\n"}
          {"\t"}--ion-color-{nameLower}:{" "}
          <CodeColor color={colorValue}>{colorValue}</CodeColor>;{"\n"}
          {"\t"}--ion-color-{nameLower}-rgb:{" "}
          <CodeColor color={colorValue}>{valueRgb}</CodeColor>;{"\n"}
          {"\t"}--ion-color-{nameLower}-contrast:{" "}
          <CodeColor color={contrast}>{contrast}</CodeColor>;{"\n"}
          {"\t"}--ion-color-{nameLower}-contrast-rgb:{" "}
          <CodeColor color={contrast}>{contrastRgb}</CodeColor>;{"\n"}
          {"\t"}--ion-color-{nameLower}-shade:{" "}
          <CodeColor color={shade}>{shade}</CodeColor>;{"\n"}
          {"\t"}--ion-color-{nameLower}-tint:{" "}
          <CodeColor color={tint}>{tint}</CodeColor>;{"\n"}
          {"}"}
          {"\n"}
          {"\n"}
          .ion-color-{nameLower} {"{"}
          ...
          {"\n"}
          {"\t"}--ion-color-contrast-rgb: var(--ion-color-{nameLower}
          -contrast-rgb);{"\n"}
