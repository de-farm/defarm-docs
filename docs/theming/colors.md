...
import LayeredColorsSelect from '@site/src/components/page/theming/LayeredColorsSelect';
import NewColorGenerator from '@site/src/components/page/theming/NewColorGenerator';
